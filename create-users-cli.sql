-- Create 12 new users with Gmail pattern
-- Run with: supabase db reset --db-url "postgresql://postgres:[password]@db.kojgbqlxerixvckiraus.supabase.co:5432/postgres" --file create-users-cli.sql
