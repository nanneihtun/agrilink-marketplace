-- Simple script to add rating columns to users table and create reviews table
-- This assumes you're using the 'users' table (not users_backup)
...
-- Drop existing reviews table if it exists (to fix foreign key issues)
DROP TABLE IF EXISTS public.reviews CASCADE;

-- Create reviews table with correct foreign key references to users table
